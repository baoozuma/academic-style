...
\newtcbtheorem[number within=section]{definition}{Definition}%
  {colback=green!2!white, colframe=green!40!black,
   boxed title style={enhanced, top=2mm, toprule=1pt,enlarge top by=3mm, enlarge bottom by=3mm},
   boxrule=0.8pt,  
   breakable,
   before upper={\leavevmode\parindent0pt}
}{def}
...
\newtcbtheorem[number within=section]{lemma}{Lemma}%
  {colback=yellow!20!white, colframe=orange!100!black,
   boxed title style={enhanced, top=2mm, toprule=1pt,enlarge top by=3mm, enlarge bottom by=3mm},,coltitle=black,
   boxrule=0.8pt,  
   breakable,
   before upper={\leavevmode\parindent0pt}
}{lem}
